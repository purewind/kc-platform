...
public class SignupController {
    ...
    public String signup(@Valid @ModelAttribute SignupForm signupForm, Errors errors, RedirectAttributes ra) {
        ...
        Member member = accountService.saveUser(signupForm.createAccount());
//		accountService.signin(member);
        //SecurityUtils.getSubject().login(new UsernamePasswordToken(member.getLoginName(), member.getPassword()));
